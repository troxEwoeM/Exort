...
namespace Exort.Wpf.FluentDesign
{
    public class AcrylicBrushExtension : MarkupExtension
    {
        ...
        public override object ProvideValue(IServiceProvider serviceProvider)
        {
            ...
            if (!(pvt.TargetObject is FrameworkElement target))
                throw new ArgumentException(nameof(pvt.TargetObject));
            ...
            BindingOperations.SetBinding(acrylicPanel, AcrylicPanel.TargetProperty, new Binding() { ElementName = TargetName });
    ...
    public class BrushTranslationConverter : IMultiValueConverter
    {
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            if (parent == null) throw new ArgumentException(nameof(values));
